...
1. Rename the zip to include the full version tag: `Make-Super-Earth-Great-Again-v{VERSION}-hd{BUILD_ID}.zip`
...
gh release create "v{VERSION}-hd{BUILD_ID}" \
    "output/dist/Make-Super-Earth-Great-Again-v{VERSION}-hd{BUILD_ID}.zip" \
